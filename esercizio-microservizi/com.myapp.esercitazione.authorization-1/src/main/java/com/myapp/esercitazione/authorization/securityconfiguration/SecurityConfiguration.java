...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    /***
     * Metodo per la configurazione della sicurezza degli endpoint, 
     * quelli in elenco sono gli endpoint che non richiedono la sicurezza.
     */
    ...
    @Autowired
    private TokenAuthProvider authenticationProvider;
